<?php
    ...
    $q = "SELECT * FROM movie_stream WHERE genre_name = 'Documentary'";
    $r = mysqli_query($link, $q);

    # Retrieve titles tagged as Documentary from tv_show table
    $q2 = "SELECT * FROM tv_show WHERE genre_name = 'Documentary'";
    $r2 = mysqli_query($link, $q2);

    echo '<h3>Documentary</h3>';

    # Display movies and TV shows in carousel
?>
<div id="MyCarosel4" class="carousel slide" data-ride="carousel" data-interval="false">
    ...
    <a class="carousel-control-prev" href="#MyCarosel4" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#MyCarosel4" role="button" data-slide="next">
