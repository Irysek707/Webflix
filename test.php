                ...
                <div class="flex-container flex-cont">
                  ...
                  if (mysqli_num_rows($r) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
                      echo '<strong>Subscription status:</strong> ' . $row['status'] . ' </p>';

                      if ($row['status'] == "active") {

                        echo '<strong>Next payment due:</strong> ' . $row['expiration_date'] . ' </p>';
                      } else {
                    ...
                    echo '<strong>Subscription status:</strong> inactive </p>
