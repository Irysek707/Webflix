...
<footer class="blockquote-footer">
  ...
  echo '<div class="container"><br><button type="button" class="btn btn-secondary" role="button" data-toggle="modal" data-target="#rev">Add Movie Review</button><br></div>';
 ...
 <div class="container"><br><button type="button" class="btn btn-secondary" role="button" data-toggle="modal" data-target="#rev">Add Movie Review</button><br></div>
  <div>';
}
