<?php
    ...
    $q = "SELECT * FROM movie_stream WHERE genre_name = 'Crime'";
    $r = mysqli_query($link, $q);

    # Retrieve titles tagged as Crime from tv_show table
    $q2 = "SELECT * FROM tv_show WHERE genre_name = 'Crime'";
...
?>
<div id="MyCarosel3" class="carousel slide" data-ride="carousel" data-interval="false">
    ...
    <a class="carousel-control-prev" href="#MyCarosel3" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#MyCarosel3" role="button" data-slide="next">
